...
export default function CSREventClient() {
  ...
  const fetchEventDetails = async () => {
    try {
      ...
      setEvent(data);
      const questionsList = data.current_questions || data.questions || [];
  ...
  return (
    <div className="max-w-4xl mx-auto py-8">
      ...
      <div className="space-y-8">
        ...
        {!event.complete && (event.current_questions || event.questions) ? (
          <div className="space-y-6">
            <h2 className="text-lg font-medium text-gray-900">Additional Information Needed</h2>
            {(event.current_questions || event.questions || []).map((question, index) => (
