...
const buttonVariants = cva(
  "inline-flex items-center justify-center rounded-xl text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-emerald-700/50 text-white hover:bg-emerald-700/60",
        destructive: "bg-red-500/50 text-white hover:bg-red-500/60",
        outline:
          "border border-emerald-400/40 bg-white/10 hover:bg-white/20 text-emerald-700",
        secondary:
